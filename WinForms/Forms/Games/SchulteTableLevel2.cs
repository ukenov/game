...
{
    public partial class SchulteTableLevel2 : Form
    {
        ...
        private void SchulteTableLevel2_Load(object sender, EventArgs e)
        {
            timer1.Enabled = true;
            timer1.Stop();
        }

        private void SchulteTableLevel2_Shown(object sender, EventArgs e)
        {
            _wrongCount = 0;
            _successCount = 0;
            _nextNumber = 0;
