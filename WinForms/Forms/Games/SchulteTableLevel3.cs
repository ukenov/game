...
{
    public partial class SchulteTableLevel3 : Form
    {
        ...
        void AssignNumbersToSquare()
        {
            ...
            foreach (Button btn in panel1.Controls)
            {
                while (labelList.Contains(labelIndex))
                    labelIndex = rand.Next(47);

                btn.Text = labelIndex + "";
                labelList.Add(labelIndex);
            }
        }
        private void SchulteTableLevel3_Load(object sender, EventArgs e)
        {
            timer1.Enabled = true;
            timer1.Stop();
        }
        ...
        private void SchulteTableLevel3_Shown(object sender, EventArgs e)
        {
            _wrongCount = 0;
            _successCount = 0;
            _nextNumber = 0;
