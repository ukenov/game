...
{
    public partial class CoubeGame : Form
    {
        ...
        private void CheckForWinner()
        {
            ...
            var resultGame = new Statistic { Created = _start, GameType = GameType.CoubeGame, SuccessCount = _successCount, User = use, WrongCount = _wrongCounter };
        ...
        private void CoubeGame_Load(object sender, EventArgs e)
        {
        }
